...
process_noise_v_k_minus_1 = np.array([0.01, 0.01, 0.003]) # noice by comands
...
def main():
    ...
    state_estimate_k_minus_1 = np.array([0.0, 0.0, 0.0]) # [meters, meters, radians] ,start position
    control_vector_k_minus_1 = np.array([0, 0.0])  # [v, yaw_rate] [meters/second, radians/second]
